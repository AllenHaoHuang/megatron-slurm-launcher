...
: "${MODEL_ENV:=moe_2b/alpha_sweep_256e/alpha1}"  # override to select a different model
...
# -- Checkpointing --
LOAD_CKPT=false
LOAD_EXP_NAME=moe_ltv_2b5_a440m-swiglu-md_decoupling-8n-4096sl-128gbsz-2mbsz-1e-3lr-1tp-1pp-1ep-1etp-1cp-mockrfalse-offfalse-dbgfalse-epoverlapfalse-fuguan-moe-act-offload-435a9063-2026-07-05
